package com.example.ex32_xmljsonex;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void getJsonData3(){
        ...
        try{
            ...
            JSONObject menuObj = jobj.getJSONObject("menu");

            String attributeId = menuObj.getString("id");
            String attributeValue = menuObj.getString("value");
            JSONObject popupObject = menuObj.getJSONObject("popup");
