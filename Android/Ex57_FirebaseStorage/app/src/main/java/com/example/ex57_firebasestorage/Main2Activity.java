package com.example.ex57_firebasestorage;
...
public class Main2Activity extends AppCompatActivity {
    ...
    public void onBtn1Clicked(View v){ takeAPicture(); }

    public void onBtn2Clicked(View v){ selectFromAlbum(); }

    public void onBtn3Clicked(View v){ imageUpload1(); }
    ...
    private void takeAPicture(){
        ...
        try{
            ...
            Log.d(TAG, "aaaaaaaa : " + photoFile.getName().toString());
        } catch (IOException e){
            e.printStackTrace();
        }
