package com.example.ex44_sqlite1;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onBtn2clicked(View v){
        String sql = "create table if not exists customer (name text, age integer, moblie text) ";
        try{
    ...
    public void onBtn3clicked(View v){
        String sql1 = "insert into customer (name, age, moblie) values ('홍길동', 20, '010-1111-2222') ";
        String sql2 = "insert into customer (name, age, moblie) values ('강감찬', 25, '010-7777-2222') ";
