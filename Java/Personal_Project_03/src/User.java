...
public class User {
    ...
    public static final String WHISPERWAIT = "WHIW"; // 귓속말 to 대기방
    public static final String WHISPERROOM = "WHIR"; // 귓속말 to chatroom

    // 관리자 커맨드
    public static final String ANNOUNCE = "AN"; // 공지사항
