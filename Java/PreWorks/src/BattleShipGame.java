...
class BattleShip_Orgin {
    ...
    protected boolean fire(int x, int y){
        if((x == getX_pos_1() && y ==getX_pos_1()) || (x == getX_pos_2()) && (y == getY_pos_2())){
            this.Hit();
            return true;
        }
        return false;
    ...
    protected boolean fire(){
        ...
        if((x_ran == getX_pos_1() && y_ran ==getX_pos_1()) || (x_ran == getX_pos_2()) && (y_ran == getY_pos_2())){
            this.Hit();
            return true;
        }
...
public class BattleShipGame {
    ...
    protected static void play() {
        ...
        BattleShip_Orgin enemy = new BattleShip_Orgin();
        BattleShip_Orgin player = new BattleShip_Orgin();
    ...
    protected static BattleShip_Orgin genPlayer(){
        Scanner sc = new Scanner(System.in);
        int x,y;
