    ...
    private void Commnadlist(String str){
        ...
        if(menu.equals("/noword")){
            ...
            if(token.hasMoreTokens()){
                ...
                word = JOptionPane.showInputDialog("추가하고자 하는 금칙어를 입력해 주십시오 : ");
                if(word.length() != 0){
            ...
            client.getUser().getPersonalBadword().add(word);

            chatArea.append(word + "(이)가 금칙어로 추가되었습니다..\n");
            chatField.setText("");
...
//                System.out.println(temp.toProtocol());
        ...
        if(menu.equals("/roommax") || menu.equals("/max")){
            if(client.user.getAdmin() == true || client.user.equals(this.room.getMaster())){
                ...
                chatArea.append("해당 커맨드는 관리자만 사용할 수 있습니다.\n");
                chatField.setText("");
            }
        }
